...
ADJECTIVES: list = ["amazing", "memorable", "mind boggling", "tough", "photogenic"]
ACTIONS: list = ["visited", "toured", "stayed at", "thought of", "enjoyed"]
TOPICS: list = ["a museum", "a stadium", "a country", "a restaurant", "a toy store"]
